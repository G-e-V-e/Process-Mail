...
* The body of the mail message contains of what your want it to contain. You can supply text, variable contents and/or objects. A mail for a failed process will probably include the errormessage variable or object $error[0].
